...
class TestEISY(unittest.TestCase):
    ...
    def test_get_nodes(self, mock_get):
        ...
        self.assertIsNotNone(nodes, "Nodes response is null")
    ...
    def test_get_scenes(self, mock_get):
        ...
        self.assertIsNotNone(scenes, "Scenes response is null")
    ...
    def test_get_location(self, mock_get):
        ...
        self.assertIsNotNone(location, "Location response is null")
    ...
    def test_enable_node(self, mock_post):
        ...
        self.assertIsNotNone(result, "Enable node response is null")
    ...
    def test_disable_node(self, mock_post):
        ...
        self.assertIsNotNone(result, "Disable node response is null")
        self.assertTrue(result)
